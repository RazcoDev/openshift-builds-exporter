def update_duration_metric(duration_metric, results_json_list: list) -> None:
    [duration_metric.metric.set({'node': result['node_name']}, result['result']) for result in results_json_list]
