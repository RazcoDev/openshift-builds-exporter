...
async def create_resources(openshift_api: Api, namespace: str, nodes_names_list: list):
    ...
    buildconfigs_creation_res = await create_buildconfigs(openshift_api, namespace, buildconfigs_names_list,
                                                          nodes_names_list,
                                                          imagestreams_names_list)
    deploymentconfigs_creation_res = await create_deploymentconfigs(openshift_api, namespace,
                                                                    deploymentconfigs_names_list, nodes_names_list)
